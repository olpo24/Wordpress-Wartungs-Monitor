 ...
 * Description: Zentrales Dashboard zur Verwaltung mehrerer WordPress-Instanzen mit Remote-Update-Funktionen und One-Click Login.
 * Version: 3.0.0
 * Author: Dein Name
 * License: GPL v3
...
class WP_Maintenance_Monitor {
    ...
    public function ajax_get_login_url() {
        ...
        if (isset($response['success']) && $response['success']) {
            ...
            wp_send_json_error(['message' => $response['error'] ?? 'Bridge verweigerte den Zugriff']);
        }
    }
